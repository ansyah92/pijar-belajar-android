...
Mobile.tap(findTestObject('Logout/btn_logout_kedua'), 0)

Mobile.verifyElementText(findTestObject('Logout/android.widget.TextView - Keluar Akun Pijar Belajar'), 'Keluar Akun Pijar Belajar?')

Mobile.tap(findTestObject('Logout/btn_keluar'), 0)
