...
Mobile.tap(findTestObject('Menu Profil/android.widget.TextView - Hubungi Kami'), 0)

Mobile.verifyElementText(findTestObject('Hubungi Kami/android.widget.TextView - Kontak Pijar Belajar'), 'Kontak Pijar Belajar')
