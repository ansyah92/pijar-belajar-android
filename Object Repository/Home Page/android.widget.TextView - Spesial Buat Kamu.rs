...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Spesial Buat Kamu</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Spesial Buat Kamu' or . = 'Spesial Buat Kamu')]</locator>
