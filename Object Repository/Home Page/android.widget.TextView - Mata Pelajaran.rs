...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Mata Pelajaran</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Mata Pelajaran' or . = 'Mata Pelajaran')]</locator>
