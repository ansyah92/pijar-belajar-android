...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Latihan UNBK  UTBK</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Latihan UNBK &amp; UTBK' or . = 'Latihan UNBK &amp; UTBK')]</locator>
