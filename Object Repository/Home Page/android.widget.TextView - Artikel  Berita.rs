...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Artikel  Berita</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Artikel &amp; Berita' or . = 'Artikel &amp; Berita')]</locator>
