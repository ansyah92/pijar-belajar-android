...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Tentang Kami</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Tentang Kami' or . = 'Tentang Kami') and @resource-id = 'about-us']</locator>
