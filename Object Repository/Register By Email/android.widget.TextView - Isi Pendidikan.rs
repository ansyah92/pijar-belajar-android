...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Isi Pendidikan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Isi Pendidikan' or . = 'Isi Pendidikan')]</locator>
