...
<MobileElementEntity>
   ...
   <name>Button - Gunakan Voucher</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Gunakan Voucher' or . = 'Gunakan Voucher')]</locator>
