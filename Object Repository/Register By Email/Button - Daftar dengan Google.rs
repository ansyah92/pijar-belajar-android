...
<MobileElementEntity>
   ...
   <name>Button - Daftar dengan Google</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Daftar dengan Google' or . = 'Daftar dengan Google')]</locator>
